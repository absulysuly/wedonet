...
// Re-using icons and spinner from the old AuthModal for consistency
...
export const LoginPage: React.FC<LoginPageProps> = ({ onNavigate }) => {
    ...
    const handleSocialLogin = async (provider: 'google' | 'facebook') => {
        ...
        try {
            ...
            // On success, the AuthContext state will change and App.tsx will re-render,
            // taking the user to the dashboard or home.
        } catch (err: any) {
            setError(t(err.message) || t('errorUnexpected'));
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="min-h-[calc(100vh-200px)] bg-gray-50 flex flex-col justify-center items-center py-12 px-4">
                ...
                <div className="relative p-8">
                    ...
                    <form onSubmit={handleEmailSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="password" id="password" value={password} onChange={e => setPassword(e.target.value)} required className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500" />
                        </div>
